...
IF(CTEST_DROP_METHOD STREQUAL "https")
  ...
  SET(CTEST_BUILD_NAME "Linux-Test-<user_not_set>")

  #Not sure if these does anything?
  SET_DEFAULT_AND_FROM_ENV(CTEST_PROJECT_NAME "Test")
  ...
  SET_DEFAULT_AND_FROM_ENV(CTEST_DROP_LOCATION "/submit.php?project=Test")
